                ...
                <table id="product_table">
                    ...
                    <tbody>
                        @foreach ($data['products'] as $i)
                            @php
                                $total_price += $i['sale_price'] * $i['quantity'] * (1 + 0.01 * $i['gst_percentage']);
                            @endphp
                            <tr>
                                <td style="width:50%;">
                                    <h5>{{ $i['name'] }}</h5>
                                ...
                                @if ($data['business_state_id'] == $data['customer_state_id'])
                                    <td class="amount">
                                        ...
                                        <br>
                                        {{ App\Helpers\Helper::customMoneyFormat($i['sale_price'] * $i['quantity'] * $i['gst_percentage'] * 0.005) }}
                                    </td>
                                    <td class="amount">
                                        {{ $i['gst_percentage'] * 0.5 }}%
                                        <br>
                                ...
                                @else
                                    <td class="amount" colspan="1">
                                        {{ $i['gst_percentage'] }}%
                                        <br>
                                        {{ App\Helpers\Helper::customMoneyFormat($i['sale_price'] * $i['quantity'] * $i['gst_percentage'] * 0.01) }}
                                    </td>
                                @endif
                                <td>
                                    {{ App\Helpers\Helper::customMoneyFormat($i['sale_price'] * $i['quantity'] * (1 + 0.01 * $i['gst_percentage'])) }}
                                </td>
                            </tr>
                        @endforeach
