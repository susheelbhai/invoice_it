<footer class="footer-area">
    <img src="{{ asset('themes/guest') }}/assets/imgs/bg-shape-4.svg" alt="Shape" class="animation-slide-right bg-shape" />
    <div class="footer-top">
        <div class="custom-container">
            <div class="custom-row align-items-end justify-content-between">
                <div class="left-content">
                    <a href="{{ route('home') }}" class="logo">
                        <img src="{{ asset('images/logo/logo-white.png') }}" alt="Logo" width="180px" />
                    </a>
    ...
    <div class="copyright-area">
        <div class="custom-container">
            <div class="custom-row d-flex align-items-center justify-content-between">
                ...
                <p>&copy; 2023 All rights reserved by <a href="{{ route('home') }}"> Digamite </a></p>
            </div>
        </div>
    </div>
</footer>