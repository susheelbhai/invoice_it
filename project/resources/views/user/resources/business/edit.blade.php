<x-layout.user.app>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <x-form.type.standard title="Edit Business" action="{{ route('business.update', $data['id']) }}">
                @method('patch')
                ...
                <x-form.element.form-group title="Bank Detail">
                    <x-form.element.input1 name="bank_address" :value="$data['bank_address']" label="Bank Address" />
                    <x-form.element.input1 name="ifsc" :value="$data['ifsc']" label="IFSC Code" />
                    <x-form.element.input1 name="account_holder_name" :value="$data['account_holder_name']" label="Account Holter Name" />
                    <x-form.element.input1 name="account_number" :value="$data['account_number']" label="Account Number" />
                </x-form.element.form-group>
